...
from engine.extre_module.ultralytics_nn.block import MetaFormer_Block
...
__all__ = ['HGNetv2_MF_APB_CGLU']     

module_ = partial(APBottleneck, e=1.0)
mlp_ = ConvolutionalGLU
module = partial(MetaFormer_Block, token_mixer=module_, mlp=mlp_)

class HG_Stage_MF_APB_CGLU(HG_Stage):   
...
@register()
class HGNetv2_MF_APB_CGLU(HGNetv2):
    arch_configs = {    
        'B0': { 
